...
procedure TRptForm8.QuickRepAfterPreview(Sender: TObject);
begin
     TableRPT.Close ;
     try
...
procedure TRptForm8.QuickRepAfterPrint(Sender: TObject);
begin
     TableRPT.Close ;
     try
        TableRPT.DeleteTable ;
...
procedure TRptForm8.QuickRepBeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
var
   i : integer ;
begin
     ...
     begin
          ...
          QueryUSER.SQL.Clear ;
          QueryUSER.SQL.Add( 'SELECT * FROM"'+PrjHead.FileName+'" WHERE ID="RCJ" AND NUM=1 AND LABFEE>0.0' ) ;
...
procedure TRptForm8.QRDBText4Print(sender: TObject; var Value: String);
begin
