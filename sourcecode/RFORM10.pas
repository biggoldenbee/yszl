...
var
  RptForm10: TRptForm10;

implementation
uses Main,YSZLDBS ;
{$R *.DFM}

procedure TRptForm10.QuickRepAfterPreview(Sender: TObject);
begin
     TableRPT.Close ;
     try
...
procedure TRptForm10.QuickRepAfterPrint(Sender: TObject);
begin
     TableRPT.Close ;
     try
        TableRPT.DeleteTable ;
...
procedure TRptForm10.QuickRepBeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
var
   i : integer ;
begin
     ...
     begin
          ...
          QueryUSER.SQL.Clear ;
          QueryUSER.SQL.Add( 'SELECT * FROM"'+PrjHead.FileName+'" WHERE ID="RCJ" AND NUM=3 AND LABFEE>0.0' ) ;
...
procedure TRptForm10.QRDBText4Print(sender: TObject; var Value: String);
begin
