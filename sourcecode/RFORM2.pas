...
procedure TRptForm2.QuickRepAfterPreview(Sender: TObject);
begin
     TableRPT.Close ;
     try
...
procedure TRptForm2.QuickRepAfterPrint(Sender: TObject);
begin
     TableRPT.Close ;
     try
        TableRPT.DeleteTable ;
...
procedure TRptForm2.QuickRepBeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
...
procedure TRptForm2.QRDBText5Print(sender: TObject; var Value: String);
begin
