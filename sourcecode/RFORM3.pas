...
procedure TRptForm3.QuickRepAfterPreview(Sender: TObject);
begin
     TableRPT.Close ;
     try
...
procedure TRptForm3.QuickRepAfterPrint(Sender: TObject);
begin
     TableRPT.Close ;
     try
        TableRPT.DeleteTable ;
...
procedure TRptForm3.QuickRepBeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
...
procedure TRptForm3.QRDBText5Print(sender: TObject; var Value: String);
begin
