...
var
  RptForm12: TRptForm12;

implementation
uses Main,YSZLDBS ;
{$R *.DFM}

procedure TRptForm12.QuickRepAfterPreview(Sender: TObject);
begin
     TableRPT.Close ;
     try
...
procedure TRptForm12.QuickRepAfterPrint(Sender: TObject);
begin
     TableRPT.Close ;
     try
        TableRPT.DeleteTable ;
...
procedure TRptForm12.QuickRepBeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
     ...
     begin
          ...
          QueryUSER.SQL.Clear ;
          QueryUSER.SQL.Add( 'SELECT * FROM"'+PrjHead.FileName+'" WHERE ID="JGCL" AND ATTRIB="1"' ) ;
...
procedure TRptForm12.QRDBText4Print(sender: TObject; var Value: String);
begin
