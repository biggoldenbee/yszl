...
var
  RptForm15: TRptForm15;

implementation
uses Main,YSZLDBS ;
{$R *.DFM}

procedure TRptForm15.QuickRepAfterPreview(Sender: TObject);
begin
     TableRPT.Close ;
     try
...
procedure TRptForm15.QuickRepAfterPrint(Sender: TObject);
begin
     TableRPT.Close ;
     try
        TableRPT.DeleteTable ;
...
procedure TRptForm15.QuickRepBeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
     ...
     begin
          ...
          QueryUSER.SQL.Clear ;
          QueryUSER.SQL.Add( 'SELECT * FROM"'+PrjHead.FileName+'" WHERE ID="P$$" AND WLP="P"' ) ;
...
procedure TRptForm15.QRDBText3Print(sender: TObject; var Value: String);
begin
