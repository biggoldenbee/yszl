...
var
  RptForm13: TRptForm13;

implementation
uses Main,YSZLDBS ;
{$R *.DFM}

procedure TRptForm13.QuickRepAfterPreview(Sender: TObject);
begin
     TableRPT.Close ;
     try
...
procedure TRptForm13.QuickRepAfterPrint(Sender: TObject);
begin
     TableRPT.Close ;
     try
        TableRPT.DeleteTable ;
...
procedure TRptForm13.QuickRepBeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
     ...
     begin
          ...
          QueryUSER.SQL.Clear ;
          QueryUSER.SQL.Add( 'SELECT * FROM"'+PrjHead.FileName+'" WHERE ID="SBQD" AND ATTRIB="1"' ) ;
...
procedure TRptForm13.QRDBText4Print(sender: TObject; var Value: String);
begin
